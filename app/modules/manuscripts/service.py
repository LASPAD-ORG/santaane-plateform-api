...
class ManuscriptService:
    ...
    async def submit_manuscript(
        ...
        return ManuscriptResponse(
            ...
            authorId=created_manuscript.author_id,
            authorName="",  # Will be populated from User relationship in real scenario
            themeId=created_manuscript.theme_id,
            themeName=theme.title if theme else None,
            sectionId=created_manuscript.section_id,
            sectionName=section.name,
            languageId=created_manuscript.language_id,
